...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "AiDialX" },
      { title: "AiDialX Lite" },
      { name: "description", content: "AiDialX Lite — WebRTC softphone + CRM for outbound dialing with Asterisk & Telnyx." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "AiDialX Lite" },
      { property: "og:description", content: "AiDialX Lite — WebRTC softphone + CRM for outbound dialing with Asterisk & Telnyx." },
